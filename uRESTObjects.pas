...
begin
  ...
  *)
  ...
  begin
    ...
    LObject.AddPair(TJSONPair.Create('donotencode', TJSONBool.Create( TRESTRequestParameterOption.poDoNotEncode in LParameter.Options )));
    LParams.Add(LObject);
  end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        LPair := LObject.Get('donotencode');
        if Assigned(LPair) then
          if ( LPair.JsonValue as TJSONBool ).AsBoolean then
            LParameter.Options := LParameter.Options + [ TRESTRequestParameterOption.poDoNotEncode ]
          else
            LParameter.Options := LParameter.Options - [ TRESTRequestParameterOption.poDoNotEncode ];
      end;
    end;
